...
initialWorld i = World startingDate ["A", "B", "C", "D", "E"] [100,100,100,100,100] [[],[],[],[],[]] [False, False, False, False, False] 0 0 0 0 (buffalo_head) (blue_river) 0 0.0 0.0 1 "Start" 1 0 "" False 0  "test" "Cloudy" 42 [] i

nWorld :: World -> World
nWorld w = World startingDate ["A", "B", "C", "D", "E"] [100,100,100,100,100] [[],[],[],[],[]] [False, False, False, False, False] 0 0 0 0 (buffalo_head) (blue_river) 0 0.0 0.0 1 "Start" 1 0 "" False 0  "test" "Cloudy" 42 [] (imgs w)
